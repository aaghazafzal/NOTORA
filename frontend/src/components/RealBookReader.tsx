              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 hover:bg-white/10 hidden sm:inline-flex"
                    onClick={handlePrint}
                  >
              ...
              <>
                <div className="flex items-center justify-between p-2 border-b border-white/10">
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 lg:hidden ml-1 hover:bg-white/10 shrink-0"
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-4 outline-sidebar">
                  {numPages && (
                    <Document file={fileUrl} className="w-full">
                      {sidebarTab === "outline" && (
                        <Outline
                          ...
                          {Array.from(new Array(numPages), (el, index) => (
                            ...
                            >
                              <Page
                                ...
                                loading={
                                  <div className="w-[120px] h-[160px] bg-white/5 animate-pulse" />
                                }
                              />
                              <div className="text-center text-xs mt-1 text-white/50">
                                {index + 1}
                              </div>
                            </div>
                          ))}
              ...
              {numPages && (
                <>
                  <div
                    ...
                    style={{
                      filter: invertColors
                        ? "invert(1) hue-rotate(180deg) brightness(0.95) contrast(0.95)"
                        : "none",
                    }}
                  >
                    <Page
          ...
          <footer className="h-16 flex-none bg-[#1A1A24] border-t border-white/10 px-4 sm:px-8 flex items-center justify-between gap-4 z-10 shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <form
                ...
                className="flex items-center gap-2 bg-black/30 rounded-md border border-white/10 px-2 py-1"
              >
                <Input
